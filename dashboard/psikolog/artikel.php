         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="breadcrumb-holder">
                  <h1 class="main-title float-left">Artikel</h1>
               ...
               <div class="card mb-3">
                  <div class="card-header">
                     <table width="100%">
                        <tr>
                           <td>
                              <h3><i class="fas fa-table"></i> List Artikel Anda</h3>
                              Anda dapat membuat dan mengedit artikel yang anda buat.
                           </td>
                           <td>
                     ...
                     <div class="table-responsive">
                        <table id="table12" class="table table-bordered table-hover display" style="width:100%">
                           ...
                           <tbody>
                              <?php
                                 $no = 0;
                                     $sql = "SELECT * FROM tbl_post where id_user='$id_user' ";
                                     $query = $db->query($sql);
                                     while ($result=mysqli_fetch_assoc($query)) {
