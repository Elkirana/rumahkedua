                                ...
                                <div class="card-header">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><h3><div id="stat_end"></div></h3>
                                              <script type="text/javascript">
                                                $(document).ready(function(){
                                                  setInterval(function() {
                                                    $("#stat_end").load("ajax/getmessage.php?statend=true&id=<?php echo $_GET['id']; ?>");
                                                  }, 1000);
                                                });
                                              </script>
                                          </td>
...
<script type="text/javascript">
            ...
            $(document).on('click','#endchat',function(e){
           var idd= $(this).attr('data-id');
           swal({
               title: "Apa anda ingin Mengakhiri Sesi Chat ?",
               text: "",
               icon: "warning",
               buttons: true,
               dangerMode: true,
                   ...
                   $.ajax({
                       ...
                       success: function(response) {
                           ...
                           if (obj['status']!=1) {
                               ...
                               swal({title:'Good job!', text: 'Chat Berhasil Diakhiri', icon: "success"}).then((value) => {
