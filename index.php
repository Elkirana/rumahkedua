      ...
      <div class="slideBanner">
         <div class="header_banner">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
               ...
               $no = 0;
               if ($row_slide==0) {
                  $sql_slide = "SELECT * FROM tbl_post where status_slider ='0' order by id desc ";
                  $query_slide = $db->query($sql_slide);
                  ...
                  while ($result_slideok = mysqli_fetch_assoc($query_slide)) {
                     $sql_slide = "SELECT * FROM tbl_post where status_slider ='1' order by id desc ";
                     $query_slide = $db->query($sql_slide);
                     while ($result_slide = mysqli_fetch_assoc($query_slide)) {
                        if ($no>=3) {
                           break;
         ...
         <div id="horizontalTab" class="curhat-tabs-menu">
           ...
           <div class="curhat-tabs-container">
            <div class="tab-1 artikel-content">
               <?php
               $sql_post = "SELECT * FROM tbl_post ".$where." order by id desc";
               ...
               while ($result_post = mysqli_fetch_assoc($query_post)) {
                  ...
                  <h4 class="title-articles"><a class="link-post-detail" href="post.php?id='.enurl($result_post['id']).'">'.$judul.'</a></h4>
                  <div class="media">
